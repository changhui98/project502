...
public class QBoardData extends EntityPathBase<BoardData> {
    ...
    private static final long serialVersionUID = -1598756306L;
    ...
    public final org.choongang.member.entitys.QMember member;
    ...
    public QBoardData(Class<? extends BoardData> type, PathMetadata metadata, PathInits inits) {
        ...
        this.member = inits.isInitialized("member") ? new org.choongang.member.entitys.QMember(forProperty("member")) : null;
    }
