...
import org.choongang.board.entitys.*;
import org.choongang.board.repository.BoardDataRepository;
import org.choongang.board.repository.BoardViewRepository;
...
public class BoardInfoService {
    ...
    public ListData<BoardData> getList(String bid, BoardDataSearch search) {
        ...
        if (StringUtils.hasText(skey)) {
            ...
            BooleanExpression subjectCond = boardData.subject.contains(skey);
            // 제목 - subject LIKE '%skey%';
    ...
    public void addBoardData(BoardData boardData){
        ...
        // 비회원 비밀번호 인증 여부 세션에 있는 guest_confirmed_게시글 번호 true -> 인증
