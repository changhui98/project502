...
public class RequestBoardConfig {
    ...
    private int rowsPerPage = 20; // 1 페이지 게시글 수
    ...
    private String listAccessType = "ALL"; // 권한 설정 - 글 목록

    private String viewAccessType = "ALL"; // 권한 설정 - 글 보기

    private String writeAccessType = "ALL"; // 권한 설정 - 글 쓰기
